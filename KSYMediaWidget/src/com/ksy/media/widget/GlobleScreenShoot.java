...
public class GlobleScreenShoot {
	 ...
	 */
	@SuppressLint("NewApi")
	public GlobleScreenShoot(Context context) {
		...
		mScreenshotLayout = layoutInflater.inflate(R.layout.globle_screenshot,
				null);
		mBackgroundView = (ImageView) mScreenshotLayout
				.findViewById(R.id.global_screenshot_background);
		mScreenshotView = (ImageView) mScreenshotLayout
				.findViewById(R.id.global_screenshot);
		mScreenshotFlash = (ImageView) mScreenshotLayout
				.findViewById(R.id.global_screenshot_flash);
		...
		mBgPadding = (float) r
				.getDimensionPixelSize(R.dimen.global_screenshot_bg_padding);
	 ...
	 */
	@SuppressLint("NewApi")
	void takeScreenshot(View view, Runnable finisher, boolean statusBarVisible,
	 ...
	 */
	@SuppressLint("NewApi")
	private void startAnimation(final Runnable finisher, int w, int h,
		...
		ValueAnimator screenshotFadeOutAnim = createScreenshotDropOutAnimation(
				w, h, statusBarVisible, navBarVisible);
	...
	private ValueAnimator createScreenshotDropInAnimation() {
		...
		anim.addUpdateListener(new AnimatorUpdateListener() {
			...
			public void onAnimationUpdate(ValueAnimator animation) {
				...
				mBackgroundView.setAlpha(scaleInterpolator.getInterpolation(t)
						* BACKGROUND_ALPHA);
				mScreenshotView.setAlpha(t);
				mScreenshotView.setScaleX(scaleT);
				mScreenshotView.setScaleY(scaleT);
				mScreenshotFlash.setAlpha(flashAlphaInterpolator
						.getInterpolation(t));
			}
		});
		return anim;
	...
	private ValueAnimator createScreenshotDropOutAnimation(int w, int h,
		...
		if (!statusBarVisible || !navBarVisible) {
			...
			final Interpolator scaleInterpolator = new Interpolator() {
				...
				public float getInterpolation(float x) {
					if (x < scaleDurationPct) {
						...
						return (float) (1f - Math.pow(
								1f - (x / scaleDurationPct), 2f));
					}
					return 1f;
				}
			};
			...
			final PointF finalPos = new PointF(-halfScreenWidth
			...
			anim.addUpdateListener(new AnimatorUpdateListener() {
				...
				public void onAnimationUpdate(ValueAnimator animation) {
					...
					mBackgroundView.setAlpha((1f - t) * BACKGROUND_ALPHA);
					mScreenshotView.setAlpha(1f - scaleInterpolator
							.getInterpolation(t));
					mScreenshotView.setScaleX(scaleT);
					mScreenshotView.setScaleY(scaleT);
