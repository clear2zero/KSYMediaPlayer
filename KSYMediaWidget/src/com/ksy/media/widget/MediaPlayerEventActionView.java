...
public class MediaPlayerEventActionView extends RelativeLayout {
    ...
    public MediaPlayerEventActionView(Context context) {
        super(context);
        LayoutInflater.from(getContext()).inflate(R.layout.media_player_event_action_view, this);
        initViews();
    }
    ...
    private void initViews(){
        ...
        mBackImageView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				 if(mCallback != null) mCallback.onActionBack();				
			}
		});
        ...
        mWaitLayout.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                if(mCallback != null) mCallback.onActionPlay();
            }
        });
        ...
        mCompeteReplayLayout.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                if(mCallback != null) mCallback.onActionReplay();
            }
        });
        ...
        mErrorReplayLayout.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                if(mCallback != null) mCallback.onActionError();
            }
        });
    ...
    public void updateCoverMode(int coverViewMode , String extraMessage){
