...
public class MediaPlayerLargeControllerView extends MediaPlayerBaseControllerView implements View.OnClickListener {
    ...
    public MediaPlayerLargeControllerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initListeners() {
        ...
        mWidgetControllerVolumeView.setCallback(new MediaPlayerControllerVolumeView.Callback() {
			...
			@Override
			public void onVolumeProgressChanged(AudioManager audioManager,
					float percentage) {
    ...
    void onShow() {
        ...
        mMediaPlayerController.onControllerShow(MediaPlayMode.PLAYMODE_FULLSCREEN);
    ...
    void onHide() {
        ...
        mMediaPlayerController.onControllerHide(MediaPlayMode.PLAYMODE_FULLSCREEN);
        ...
        if (mDeviceNavigationBarExist) {
            if (MediaPlayerUtils.isFullScreenMode(mMediaPlayerController.getPlayMode())) {
...
//            }
    ...
    public void onClick(View v) {
        ...
        if (id == mBackLayout.getId() || id == mTitleTextView.getId()) {
            mMediaPlayerController.onBackPress(MediaPlayMode.PLAYMODE_FULLSCREEN);
    ...
    private void displayQualityPopupWindow(){
        ...
        int x = MediaPlayerUtils.getXLocationOnScreen(mQualityLayout) - widthExtra/2;
        int y = MediaPlayerUtils.getYLocationOnScreen(mQualityLayout) - height;
        mQualityPopup.show(mQualityLayout, qualityList, this.mCurrentQuality, x, y, width, height);
